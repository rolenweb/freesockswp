...
<div id="contribute" class="eleganto-tab-pane">
	...
	<div class="eleganto-tab-pane-half eleganto-tab-pane-first-half">
		...
		<p><strong><?php esc_html_e( 'Found a bug? Want to contribute with a fix or create a new feature?','eleganto'); ?></strong></p>

		<p><?php esc_html_e( 'Support fourm is the place to go!','eleganto' ); ?></p>

		<p>
			<a href="<?php echo esc_url( 'http://support.themes4wp.com/' ); ?>" class="contribute-button button button-primary"><?php printf( esc_html__( '%s support forum', 'eleganto' ), 'Eleganto' ); ?></a>
		</p>
